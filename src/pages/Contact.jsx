...
import contact_logo from '../assets/contact_img.png'
const Contact = () => {
  return (
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        <img className='w-full md:max-w-[480px]' src={contact_logo} alt=''/>
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'> Email:admain@forever.com</p>
